...
export const Hero: React.FC = () => {
  ...
  const textUpY = useTransform(smoothProgress, [0, 1], [0, -120]);
  const textFade = useTransform(smoothProgress, [0, 0.6, 1], [1, 0.9, 0.2]);
  
  // BUZZ Zoom through camera effect
  ...
  // Gallery 3D carousel visibility
  ...
  // Silky Lerp mouse tracking loop
  useEffect(() => {
    let currentX = 0;
    let currentY = 0;
    let targetX = 0;
    ...
    const animateMouse = () => {
      ...
      animationFrameId = requestAnimationFrame(animateMouse);
    };
  ...
  return (
    ...
    >
      ...
      {/* PERSPECTIVE GRID: Infinite subtle scroll toward viewer */}
      <motion.div
      ...
      {/* Official CloudBee Logo Watermark Background */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 w-full flex flex-col items-center justify-between flex-grow pt-10">
        ...
        {/* BEE MOTION: Tiny Abstract Bee Element orbiting text */}
        ...
        {/* Center 3D Circular Revolving Gallery */}
        <motion.div
        ...
        >
          <div className="space-y-0.5 relative">
            ...
            <motion.h1
              ...
              style={{
                x: mousePos.targetX * 6,
                y: mousePos.targetY * 6,
              }}
            ...
            <motion.h2
              ...
              style={{
                x: mousePos.targetX * 12,
                y: mousePos.targetY * 12,
              }}
            ...
            <motion.div
              ...
              style={{
                x: mousePos.targetX * 20,
                y: mousePos.targetY * 20,
                scale: buzzZoomScale,
          ...
          {/* CTA MAGNETIC INTERACTION BUTTONS */}
